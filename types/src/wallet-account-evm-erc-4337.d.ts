...
export default class WalletAccountEvmErc4337 extends WalletAccountReadOnlyEvmErc4337 implements IWalletAccount {
     ...
     * @returns {Promise<TransactionResult>} The transaction's result.
     */
    sendTransaction(tx: EvmTransaction | EvmTransaction[], config?: Pick<EvmErc4337WalletConfig, "paymasterToken" | "isSponsored" | "sponsorshipPolicyId">): Promise<TransactionResult>;
    /**
     ...
     */
    transfer(options: TransferOptions, config?: Pick<EvmErc4337WalletConfig, "paymasterToken" | "transferMaxFee" | "isSponsored" | "sponsorshipPolicyId">): Promise<TransferResult>;
    /**
